...
- `OI Judge: Run Stress Test` supports Generator + STD + Solution stress testing and standalone runs.
- Generator + STD mode repeatedly generates input, runs STD for expected output, runs the tested solution, and compares outputs.
